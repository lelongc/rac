...
print("=== PART 3 INSPECTION (Q32-Q70) ===")
p3_questions = [q for q in t2['questions'] if q['part'] == 3]
print(f"Total Part 3 questions: {len(p3_questions)}")

groups = {}
for q in p3_questions:
...
# Check graphics in Part 3
print("\n--- Graphic questions in Part 3 ---")
for q in p3_questions:
    if q.get('image'):
