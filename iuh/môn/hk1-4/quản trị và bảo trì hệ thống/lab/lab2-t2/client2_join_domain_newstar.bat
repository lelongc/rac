@echo off
title TU DONG JOIN DOMAIN NEWSTAR.VN (CLIENT 2 - VMNET12)
echo ===================================================
echo   DANG CAU HINH TRO DNS VA JOIN DOMAIN NEWSTAR.VN
echo ===================================================

echo [1/3] Dang tro DNS ve Domain Controller (100.100.11.1)...
netsh interface ip set dns name="Local Area Connection" static 100.100.11.1
netsh interface ip set dns name="Ethernet0" static 100.100.11.1 2>nul
netsh interface ip set dns name="Ethernet" static 100.100.11.1 2>nul
