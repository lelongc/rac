...
*(Trình bày chuẩn theo mẫu bài giảng và giáo trình môn Ngôn ngữ hình thức & Ôtômát)*
...
**Giải:**
- 5 chuỗi có độ dài ngắn nhất (theo thứ tự bảng chữ cái):
  - $\lambda$ (chuỗi rỗng, độ dài 0)
  - $a$ (độ dài 1)
  - $b$ (độ dài 1)
  - $aa$ (độ dài 2)
  - $ab$ (độ dài 2)
- **Tính chất của ngôn ngữ:**
  Ngôn ngữ được sinh ra bởi văn phạm $G_1$ là tập hợp tất cả các chuỗi có thể được tạo thành từ bảng chữ cái $\{a, b\}$, bao gồm cả chuỗi rỗng.
  $$L(G_1) = \Sigma^* = \{a, b\}^*$$
...
- 5 chuỗi có độ dài ngắn nhất (theo thứ tự bảng chữ cái):
  ...
  - $bb$ (độ dài 2)
- **Tính chất của ngôn ngữ:**
  Ngôn ngữ được sinh ra bởi văn phạm $G_2$ là tập hợp tất cả các chuỗi đối xứng (palindrome) trên bảng chữ cái $\{a, b\}$ (các chuỗi đọc từ trái sang phải hay từ phải sang trái đều giống nhau).
...
- 5 chuỗi có độ dài ngắn nhất (theo thứ tự bảng chữ cái):
  ...
  - $aaaabbbb$ (độ dài 8)
- **Tính chất của ngôn ngữ:**
  Ngôn ngữ được sinh ra bởi văn phạm $G_3$ là tập hợp tất cả các chuỗi có số lượng ký tự '$a$' bằng số lượng ký tự '$b$', trong đó toàn bộ ký tự '$a$' đứng trước và toàn bộ ký tự '$b$' đứng sau.
