...
- **Extension 103**: Điện thoại Di động (App Linphone) - Pass: `123456`
...
- [ ] **Yêu cầu 1: Gọi nhóm (Ring Group)**
  ...
  - Đánh giá: Máy 102 và Điện thoại Linphone (103) cùng đổ chuông.

- [ ] **Yêu cầu 2: Gọi di động**
  - Thao tác: Bấm gọi `103` từ Win7.
  - Đánh giá: App Linphone trên điện thoại di động reo chuông và đàm thoại rõ tiếng.

- [ ] **Yêu cầu 3: Nhắn tin (SIP Messaging)**
  - Thao tác: Mở tab Message trên MicroSIP gửi tin nhắn tới `103`.
  - Đánh giá: App Linphone nhận tin nhắn hiển thị đúng nội dung.
